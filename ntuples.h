...
// Thu Oct 19 20:05:40 2017 by ROOT version 5.34/36
...
#ifdef ntuples_cxx
ntuples::ntuples(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("ggtree_mc_100.root/ggNtuplizer/EventTree");
      chain->Add("ggtree_mc_101.root/ggNtuplizer/EventTree");
      chain->Add("ggtree_mc_102.root/ggNtuplizer/EventTree");
      //chain->Add("ggtree_dataRunH_100.root/ggNtuplizer/EventTree");
      //chain->Add("ggtree_dataRunH_101.root/ggNtuplizer/EventTree");
      //chain->Add("ggtree_dataRunH_102.root/ggNtuplizer/EventTree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t ntuples::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ntuples::LoadTree(Long64_t entry)
{
...
void ntuples::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("trigDecision", &trigDecision, &b_trigDecision);
   ...
   fChain->SetBranchAddress("muIsGlob", &muIsGlob, &b_muIsGlob);
   fChain->SetBranchAddress("muIsPF", &muIsPF, &b_muIsPF);
   fChain->SetBranchAddress("muIsTrk", &muIsTrk, &b_muIsTrk);
...
void ntuples::Show(Long64_t entry)
{
...
Int_t ntuples::Cut(Long64_t entry)
{
